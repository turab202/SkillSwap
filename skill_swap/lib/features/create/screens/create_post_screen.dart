...
extension PostTypeX on PostType {
  ...
  String get descHint => switch (this) {
    PostType.offerSkill =>
      'Describe what you\'ll teach, your experience, and what you\'d like in return...',
    PostType.offerService =>
      'Describe the service, your experience, and what you\'d like in return...',
    PostType.requestHelp =>
      'Describe what you need, your timeline, and what you can offer in return...',
    PostType.communityProject =>
      'Describe the project goals, skills needed, and how people can contribute...',
    PostType.volunteer =>
      'Describe the volunteer opportunity, time commitment, and impact...',
    PostType.mentorship =>
      'Describe your expertise, mentorship style, and what mentees can expect...',
  };
}
...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _submit() async {
    ...
    final extra =
        (_type == PostType.offerService ||
            _type == PostType.communityProject ||
            _type == PostType.volunteer)
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'AI Tip: Be specific about what you offer and what you\'d like in return to get better matches.',
                        style: TextStyle(
                          fontSize: 12,
              ...
              if (_type == PostType.offerService ||
                  _type == PostType.communityProject ||
                  _type == PostType.volunteer) ...[
                const SizedBox(height: 16),
                const Text(
